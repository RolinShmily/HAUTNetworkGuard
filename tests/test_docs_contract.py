...
def main():
    ...
    require_contains(readme, "sh -s -- v1.3.15")
    ...
    require_contains(openwrt_readme, "HAUTNetworkGuard/v1.3.15/OpenWrt/install-online.sh | sh -s -- v1.3.15")
    ...
    require_contains(windows_ai, "版本号**: 1.3.15")
    ...
    require_contains(macos_ai, "版本号**: 1.3.15")
