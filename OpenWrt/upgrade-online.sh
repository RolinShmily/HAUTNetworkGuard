...
# 用法: wget -qO- https://raw.githubusercontent.com/yellowpeachxgp/HAUTNetworkGuard/main/OpenWrt/upgrade-online.sh | sh
...
# 获取远端版本
echo "正在检查最新版本..."
REMOTE_MAIN=$(curl -sL --connect-timeout 10 "$REPO_URL/files/usr/lib/haut-network-guard/main.lua")
